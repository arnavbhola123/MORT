...
class ACHWorkflow:
    ...
    def run_workflow(self, code_file: str, test_file: str):
        ...
        print("\n" + "=" * 60)
        print("STEP 3: Check syntactic identity")
        print("=" * 60)
        ...
        return {"mutant": mutated_class, "test": new_test_class}

    def _make_fault(self, context, class_under_test, existing_test_class, diff):
        """Table 1: Make a fault"""
        prompt = self.prompts.make_fault(
            context, class_under_test, existing_test_class, diff
        )
